...
const checkAndRenderResult = (data) => {
  ...
  return (
    ...
    <div className="chat-header">
      ...
      <button className="close-btn" onClick={handleCloseChat}><svg xmlns="http://www.w3.org/2000/svg" width="36" height="25" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
